...
paella.player = null;
paella.version = "6.4.5 - build: 32f5dbb";
    ...
    function VideoRect(id, domType, left, top, width, height) {
      ...
      if (zoomEnabled) {
        ...
        $(eventCapture).on('mousemove', function (evt) {
          ...
          if ((Math.abs(offset.x) > 80 || Math.abs(_this24.y) > 80) && _this24.drag) {
            _this24._mouseDown = mouse;
            return;
          }

          _this24.drag = evt.buttons > 0;

          if (_this24.drag) {
            paella.player.videoContainer.disablePlayOnClick();
            panImage.apply(_assertThisInitialized(_this24), [offset]);
            _this24._mouseDown = mouse;
          }
        });
...
(function () {
  ...
  var VideoContainerBase = /*#__PURE__*/function (_paella$DomNode7) {
    ...
    function VideoContainerBase(id) {
      ...
      _this64._clickEventsEnabled = true;
      ...
      $(_this64.domElement).dblclick(function (evt) {
        if (_this64._clickEventsEnabled) {
    ...
    _createClass(VideoContainerBase, [{
      ...
      value: function enablePlayOnClick() {
        ...
        if (timeout) {
          this._clickEventsTimeout = setTimeout(function () {
            _this67._clickEventsEnabled = true;
          }, timeout);
        } else {
      ...
      value: function seekTo(newPositionPercent) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          paella.player.videoContainer.currentTime().then(function (t) {
            ...
            if (_this68._seekTimeLimit > 0 && _this68._seekType == paella.SeekType.BACKWARDS_ONLY) {
              time = _this68._seekTimeLimit;
            }
            ...
            _this68.setCurrentPercent(newPositionPercent).then(function (timeData) {
              _this68._force = true;
      ...
      value: function seekToTime(time) {
        ...
        return new Promise(function (resolve, reject) {
          paella.player.videoContainer.currentTime().then(function (currentTime) {
            if (_this69._seekTimeLimit && _this69._seekType == paella.SeekType.BACKWARDS_ONLY) {
              currentTime = _this69._seekTimeLimit;
            }

            switch (_this69._seekType) {
              case paella.SeekType.FULL:
                break;
            ...
            _this69.setCurrentTime(time).then(function (timeData) {
              _this69._force = true;

              _this69.triggerTimeupdate();
      ...
      value: function trimStart() {
        ...
        return new Promise(function (resolve) {
          resolve(_this70._trimming.start);
        });
      }
    }, {
      key: "trimEnd",
      ...
      value: function trimEnabled() {
        ...
        return new Promise(function (resolve) {
          resolve(_this72._trimming.enabled);
        });
      }
    }, {
      key: "trimming",
      ...
      value: function setTrimming(start, end) {
        ...
        return new Promise(function (resolve) {
          ...
          _this74.currentTime(true).then(function (c) {
            currentTime = c;
            return _this74.duration();
          }).then(function (duration) {
            _this74._trimming.start = Math.floor(start);
            _this74._trimming.end = Math.floor(end);

            if (_this74._trimming.enabled) {
              if (currentTime < _this74._trimming.start) {
                _this74.setCurrentTime(0);
              }

              if (currentTime > _this74._trimming.end) {
                _this74.setCurrentTime(duration);
              }
            ...
            paella.events.trigger(paella.events.setTrim, {
              trimEnabled: _this74._trimming.enabled,
              trimStart: _this74._trimming.start,
              trimEnd: _this74._trimming.end
            });
            resolve();
          });
        });
      ...
      value: function setCurrentPercent(percent) {
        ...
        return new Promise(function (resolve) {
          _this75.duration().then(function (d) {
            ...
            return _this75.setCurrentTime(position);
      ...
      value: function ended() {
        ...
        return new Promise(function (resolve) {
          ...
          _this76.duration().then(function (d) {
            duration = d;
            return _this76.currentTime();
          }).then(function (currentTime) {
    ...
    _createClass(StreamProvider, [{
      ...
      value: function init(videoData) {
        ...
        this._videoData.forEach(function (stream, index) {
          ...
          if (stream.role == 'master') {
            _this77._mainStream = stream;
          }

          if (stream.type == 'video') {
            _this77._videoStreams.push(stream);
          } else if (stream.type == 'audio') {
            _this77._audioStreams.push(stream);
          }
        });
        ...
        this._videoStreams.forEach(function (videoStream, index) {
          ...
          player.setVideoQualityStrategy(_this77._qualityStrategy);
          player.setAutoplay(autoplay);

          if (videoStream == _this77._mainStream) {
            _this77._mainPlayer = player;
            _this77._audioPlayer = player;
          } else {
            player.setVolume(0);
          }

          _this77._videoPlayers.push(player);

          _this77._players.push(player);
        }); // Create audio player
        ...
        this._audioStreams.forEach(function (audioStream, index) {
          ...
          if (player) {
            _this77._audioPlayers.push(player);
      ...
      value: function startVideoSync(syncProviderPlayer) {
        ...
        var sync = function sync() {
          _this78._syncProviderPlayer.currentTime().then(function (t) {
            _this78.players.forEach(function (player) {
          ...
          _this78._syncTimer = setTimeout(function () {
            return sync();
          }, 1000);
        };
      ...
      value: function callPlayerFunction(fnName) {
        ...
        return new Promise(function (resolve, reject) {
          Promise.all(promises).then(function () {
            if (fnName == 'play' && !_this79._firstPlay) {
              _this79._firstPlay = true;

              if (_this79._startTime) {
                _this79.players.forEach(function (p) {
                  return p.setCurrentTime(_this79._startTime);
                });
              }
            }
  ...
  var VideoContainer = /*#__PURE__*/function (_paella$VideoContaine) {
    ...
    function VideoContainer(id) {
      ...
      _this80 = _super19.call(this, id);
      _this80._streamProvider = new paella.StreamProvider();
      _this80._ready = false;
      _this80._videoWrappers = [];
      _this80._container = new paella.DomNode('div', 'playerContainer_videoContainer_container', {
        position: 'relative',
        display: 'block',
        marginLeft: 'auto',
        marginRight: 'auto',
      ...
      _this80._container.domElement.setAttribute('role', 'main');

      _this80.addNode(_this80._container);

      _this80.overlayContainer = new paella.VideoOverlay(_this80.domElement);

      _this80.container.addNode(_this80.overlayContainer);

      _this80.setProfileFrameStrategy(paella.ProfileFrameStrategy.Factory());

      _this80.setVideoQualityStrategy(paella.VideoQualityStrategy.Factory());

      _this80._audioTag = paella.player.config.player.defaultAudioTag || paella.dictionary.currentLanguage();
      _this80._audioPlayer = null; // Initial volume level

      _this80._volume = paella.utils.cookies.get("volume") ? Number(paella.utils.cookies.get("volume")) : 1;
      _this80._muted = false;
      return _this80;
    ...
    _createClass(VideoContainer, [{
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          _this81.ended().then(function (ended) {
            if (ended) {
              _this81._streamProvider.startTime = 0;

              _this81.seekToTime(0);
            } else {
              _this81.streamProvider.startTime = _this81._startTime;
            }

            return _this81.streamProvider.callPlayerFunction('play');
          }).then(function () {
            _get(_getPrototypeOf(VideoContainer.prototype), "play", _this81).call(_this81);
      ...
      value: function pause() {
        ...
        return new Promise(function (resolve, reject) {
          _this82.streamProvider.callPlayerFunction('pause').then(function () {
            _get(_getPrototypeOf(VideoContainer.prototype), "pause", _this82).call(_this82);
      ...
      value: function setCurrentTime(time) {
        ...
        return new Promise(function (resolve, reject) {
          _this83.trimming().then(function (trimmingData) {
            ...
            return _this83.streamProvider.callPlayerFunction('setCurrentTime', time);
          }).then(function () {
            return _this83.duration(false);
          }).then(function (duration) {
            resolve({
              time: time,
              duration: duration
      ...
      value: function currentTime() {
        ...
        return new Promise(function (resolve) {
          ...
          p.then(function (t) {
            trimmingData = t;
            return _this84.masterVideo().currentTime();
          }).then(function (time) {
            if (trimmingData.enabled) {
      ...
      value: function mute() {
        ...
        return new Promise(function (resolve) {
          ...
          _this85._audioPlayer.setVolume(0).then(function () {
      ...
      value: function unmute() {
        ...
        return new Promise(function (resolve) {
          _this86._muted = false;

          _this86._audioPlayer.setVolume(_this86._volume).then(function () {
            paella.events.trigger(paella.events.setVolume, {
              master: _this86._volume
            });
            resolve();
          });
        });
      ...
      value: function setVolume(params) {
        ...
        if (_typeof(params) == 'object') {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this87._volume = params;

            _this87._audioPlayer.setVolume(params).then(function () {
              paella.events.trigger(paella.events.setVolume, {
                master: params
              });
              resolve(params);
      ...
      value: function duration() {
        ...
        return new Promise(function (resolve) {
          ...
          p.then(function (t) {
            trimmingData = t;
            return _this88.masterVideo().duration();
          }).then(function (duration) {
            if (trimmingData.enabled) {
      ...
      value: function getAudioTags() {
        ...
        return new Promise(function (resolve) {
          var lang = [];
          var p = _this89.streamProvider.players;
      ...
      value: function setAudioTag(lang) {
        ...
        return new Promise(function (resolve) {
          ...
          _this90.streamProvider.players.forEach(function (player) {
            if (!firstAudioPlayer) {
          ...
          if (!audioSet && _this90.streamProvider.mainVideoPlayer) {
            _this90._audioPlayer = _this90.streamProvider.mainVideoPlayer;
          } else if (!audioSet && firstAudioPlayer) {
            _this90._audioPlayer = firstAudioPlayer;
          }

          Promise.all(promises).then(function () {
            return _this90._audioPlayer.setVolume(_this90._volume);
          }).then(function () {
            _this90._audioTag = _this90._audioPlayer.stream.audioTag;
            paella.events.trigger(paella.events.audioTagChanged);

            _this90.streamProvider.startVideoSync(_this90.audioPlayer);
      ...
      value: function setStreamData(videoData) {
        ...
        return new Promise(function (resolve, reject) {
          _this91.streamProvider.init(videoData);
          ...
          videoData.forEach(function (video) {
            ...
            if (video.audioTag == _this91._audioTag) {
              streamDataAudioTag = _this91._audioTag;
            }
          });

          if (streamDataAudioTag != _this91._audioTag && streamDataAudioTag != null) {
            _this91._audioTag = streamDataAudioTag;
          }

          _this91.streamProvider.videoPlayers.forEach(function (player, index) {
            addVideoWrapper.apply(_this91, ['videoPlayerWrapper_' + index, player]);
            player.setAutoplay(_this91.autoplay());
          });

          _this91.streamProvider.loadVideos()["catch"](function (err) {
            reject(err);
          }).then(function () {
            return _this91.setAudioTag(_this91.audioTag);
          }).then(function () {
            var endedTimer = null;

            var setupEndEventTimer = function setupEndEventTimer() {
              _this91.stopTimeupdate();
            ...
            var eventBindingObject = _this91.masterVideo().video || _this91.masterVideo().audio;

            $(eventBindingObject).bind('timeupdate', function (evt) {
              _this91.trimming().then(function (trimmingData) {
                ...
                if (current >= duration) {
                  _this91.streamProvider.callPlayerFunction('pause');
      ...
      value: function getVideoData() {
        ...
        return new Promise(function (resolve, reject) {
          ...
          _this92.currentTime().then(function (currentTime) {
            videoData.currentTime = currentTime;
            return _this92.volume();
          }).then(function (v) {
            videoData.volume = v;
            return _this92.duration();
          }).then(function (d) {
            videoData.duration = d;
            return _this92.paused();
          }).then(function (p) {
            videoData.paused = p;
            return _this92.trimming();
          }).then(function (trimming) {
...
(function () {
  var PluginManager = /*#__PURE__*/function () {
    ...
    function PluginManager() {
      ...
      paella.events.bind(paella.events.loadPlugins, function (event) {
        _this93.loadPlugins("paella.DeferredLoadPlugin");
      });
      var timer = new base.Timer(function () {
        if (paella.player && paella.player.controls && _this93.doResize) paella.player.controls.onresize();
      }, 1000);
      timer.repeat = true;
    }
      ...
      value: function addPlugin(plugin) {
        ...
        plugin.checkEnabled(function (isEnabled) {
          if (plugin.type == "eventDriven" && isEnabled) {
            ...
            _this94.eventDrivenPlugins.push(plugin);
  ...
  var PopUpContainer = /*#__PURE__*/function (_paella$DomNode8) {
    ...
    function PopUpContainer(id, className) {
      ...
      var style = {};
      _this95 = _super23.call(this, 'div', id, style);
      _this95.containers = null;
      _this95.currentContainerId = -1;
      _this95.domElement.className = className;
      _this95.containers = {};
      return _this95;
    }
  ...
  var ButtonPlugin = /*#__PURE__*/function (_paella$UIPlugin) {
    ...
    function ButtonPlugin() {
      ...
      _this96 = _super26.call(this);
      _this96.subclass = '';
      _this96.container = null;
      _this96.containerManager = null;
      _this96._domElement = null;
      return _this96;
    }
    ...
    _createClass(ButtonPlugin, [{
      ...
      value: function rebuildMenu() {
        ...
        menuContent.forEach(function (menuItem) {
          _this97.menuContent.appendChild(getButtonItem(menuItem, _this97));
        });
      }
    }, {
      key: "menuContent",
  ...
  var EventDrivenPlugin = /*#__PURE__*/function (_paella$EarlyLoadPlug) {
    ...
    function EventDrivenPlugin() {
      ...
      var events = _this98.getEvents();

      for (var i = 0; i < events.length; ++i) {
        var event = events[i];

        if (event == paella.events.loadStarted) {
          _this98.onEvent(paella.events.loadStarted);
        }
      }
        ...
        _createClass(WebGLCanvas, [{
          ...
          value: function buildScene() {
            ...
            this.loadVideoTexture().then(function (texture) {
              _this101._texture = texture;

              _this101.buildVideoSurface(_this101._root, texture);
            });
    ...
    if (!paella.WebGLCanvas) {
      var WebGLCanvas = /*#__PURE__*/function (_bg$app$WindowControl2) {
        ...
        function WebGLCanvas(stream) {
          ...
          _this102 = _super30.call(this);
          _this102._stream = stream;
          return _this102;
        }
        ...
        _createClass(WebGLCanvas, [{
          ...
          value: function buildScene() {
            ...
            this.registerPlugins();
            this.loadVideoTexture().then(function (texture) {
              _this104._texture = texture;

              _this104.buildVideoSurface(_this104._root, texture);
            });
            var lightNode = new bg.scene.Node(this.gl, "Light");
            var light = new bg.base.Light();
            light.ambient = bg.Color.White();
...
(function () {
  ...
  var SearchCallback = /*#__PURE__*/function (_base$AsyncLoaderCall) {
    ...
    function SearchCallback(caption, text) {
      ...
      _this105.name = "captionSearchCallback";
      _this105.caption = caption;
      _this105.text = text;
      return _this105;
    }
      ...
      value: function search(txt, next) {
        ...
        if (this._index == undefined) {
          ...
          paella.player.videoContainer.trimming().then(function (trimming) {
            _this107._index.search(txt).forEach(function (s) {
...
(function () {
  ...
  var SearchCallback = /*#__PURE__*/function (_base$AsyncLoaderCall2) {
    ...
    function SearchCallback(plugin, text) {
      ...
      _this108 = _super34.call(this);
      _this108.name = "searchCallback";
      _this108.plugin = plugin;
      _this108.text = text;
      return _this108;
    }
...
(function () {
  var TimeControl = /*#__PURE__*/function (_paella$DomNode9) {
    ...
    function TimeControl(id) {
      ...
      _this111 = _super37.call(this, 'div', id, {
        left: "0%"
      });
      _this111.domElement.className = 'timeControlOld';
      _this111.domElement.className = 'timeControl'; //this.domElement.innerText = "0:00:00";
    ...
    _createClass(PlaybackBarCanvas, [{
      ...
      value: function drawCanvas() {
        ...
        paella.player.videoContainer.duration(true).then(function (d) {
          ...
          var ctx = _this113.context;
          var w = _this113.width;
          var h = _this113.height;

          _this113.clearCanvas();

          _this113._plugins.forEach(function (plugin) {
      ...
      get: function get() {
        ...
        if (!this._canvas) {
          var createCanvas = function createCanvas(index) {
            ...
            result.width = $(_this114.parent).width();
            result.height = $(_this114.parent).height();
            return result;
          };
  ...
  var PlaybackBar = /*#__PURE__*/function (_paella$DomNode10) {
    ...
    function PlaybackBar(id) {
      ...
      var style = {};
      _this115 = _super39.call(this, 'div', id, style);
      _this115.playbackFullId = '';
      _this115.updatePlayBar = true;
      _this115.timeControlId = '';
      _this115._images = null;
      _this115._prev = null;
      _this115._next = null;
      _this115._videoLength = null;
      _this115._lastSrc = null;
      _this115._aspectRatio = 1.777777778;
      _this115._hasSlides = null;
      _this115._imgNode = null;
      _this115._canvas = null;
      _this115.domElement.className = "playbackBar";

      _this115.domElement.setAttribute("alt", ""); //this.domElement.setAttribute("title", "Timeline Slider");


      _this115.domElement.setAttribute("aria-label", "Timeline Slider");

      _this115.domElement.setAttribute("role", "slider");

      _this115.domElement.setAttribute("aria-valuemin", "0");

      _this115.domElement.setAttribute("aria-valuemax", "100");

      _this115.domElement.setAttribute("aria-valuenow", "0");

      _this115.domElement.setAttribute("tabindex", paella.tabIndex.next);

      $(_this115.domElement).keyup(function (event) {
        var currentTime = 0;
        var duration = 0;
        paella.player.videoContainer.currentTime().then(function (t) {
          currentTime = t;
      ...
      _this115.playbackFullId = id + "_full";
      _this115.timeControlId = id + "_timeControl";
      var playbackFull = new paella.DomNode('div', _this115.playbackFullId, {
        width: '0%'
      });
      playbackFull.domElement.className = "playbackBarFull";

      _this115.addNode(playbackFull);

      _this115.addNode(new paella.TimeControl(_this115.timeControlId));

      var thisClass = _assertThisInitialized(_this115);

      paella.events.bind(paella.events.timeupdate, function (event, params) {
        thisClass.onTimeUpdate(params);
      });
      $(_this115.domElement).bind('mousedown', function (event) {
      ...
      if (!base.userAgent.browser.IsMobileVersion) {
        $(_this115.domElement).bind('mousemove', function (event) {
        ...
        $(_this115.domElement).bind("mouseout", function (event) {
          thisClass.mouseOut(event);
        });
      }

      _this115.domElement.addEventListener('touchstart', function (event) {
        paella.utils.mouseManager.down(thisClass, event);
        event.stopPropagation();
      }, false);

      _this115.domElement.addEventListener('touchmove', function (event) {
        thisClass.movePassive(event);
        paella.utils.mouseManager.move(event);
      }, false);

      _this115.domElement.addEventListener('touchend', function (event) {
        paella.utils.mouseManager.up(event);
        thisClass.clearTimeOverlay();
      }, false);

      $(_this115.domElement).bind('mouseup', function (event) {
        paella.utils.mouseManager.up(event);
      });
      ...
      _this115._canvas = new PlaybackBarCanvas(_this115.domElement);
      return _this115;
    }
        ...
        return new Promise(function (resolve) {
          paella.player.videoContainer.duration().then(function (duration) {
            ...
            if (!n || Object.keys(n).length === 0) {
              _this116._hasSlides = false;
              return;
            } else {
              _this116._hasSlides = true;
            }

            _this116._images = n; // COPY TO LOCAL

            _this116._videoLength = duration; // SORT KEYS FOR SEARCH CLOSEST

            _this116._keys = Object.keys(_this116._images);
            _this116._keys = _this116._keys.sort(function (a, b) {
  ...
  var PlaybackControl = /*#__PURE__*/function (_paella$DomNode11) {
      ...
      value: function addPlugin(plugin) {
        ...
        plugin.checkEnabled(function (isEnabled) {
          ...
          if (isEnabled) {
            $(plugin.button).show();
            paella.pluginManager.setupPlugin(plugin);
            var id = 'buttonPlugin' + _this118.buttonPlugins.length;

            if (plugin.getButtonType() == paella.ButtonPlugin.type.popUpButton) {
              parent = _this118.popUpPluginContainer.domElement;
              var popUpContent = paella.ButtonPlugin.BuildPluginPopUp(parent, plugin, id + '_container');

              _this118.popUpPluginContainer.registerContainer(plugin.getName(), popUpContent, button, plugin);
            } else if (plugin.getButtonType() == paella.ButtonPlugin.type.timeLineButton) {
              parent = _this118.timeLinePluginContainer.domElement;
              var timeLineContent = paella.ButtonPlugin.BuildPluginPopUp(parent, plugin, id + '_timeline');

              _this118.timeLinePluginContainer.registerContainer(plugin.getName(), timeLineContent, button, plugin);
            ...
            _this118.pluginsContainer.domElement.removeChild(plugin.button);
          }
        });
      }
    }]);
    ...
    function PlaybackControl(id) {
      ...
      var style = {};
      _this117 = _super40.call(this, 'div', id, style);
      _this117.playbackBarId = '';
      _this117.pluginsContainer = null;
      _this117._popUpPluginContainer = null;
      _this117._timeLinePluginContainer = null;
      _this117.playbackPluginsWidth = 0;
      _this117.popupPluginsWidth = 0;
      _this117.minPlaybackBarSize = 120;
      _this117.playbackBarInstance = null;
      _this117.buttonPlugins = [];
      _this117.domElement.className = 'playbackControls';
      _this117.playbackBarId = id + '_playbackBar';

      var thisClass = _assertThisInitialized(_this117);

      _this117.pluginsContainer = new paella.DomNode('div', id + '_playbackBarPlugins');
      _this117.pluginsContainer.domElement.className = 'playbackBarPlugins';

      _this117.pluginsContainer.domElement.setAttribute("role", "toolbar");

      _this117.addNode(_this117.pluginsContainer);

      _this117.addNode(new paella.PlaybackBar(_this117.playbackBarId));

      paella.pluginManager.setTarget('button', _assertThisInitialized(_this117));
      $(window).mousemove(function (evt) {
        if (_this117._expandedPlugin && $(window).height() - evt.clientY > 50) {
          _this117._expandedPlugin.contract();

          _this117._expandPlugin = null;
        }
      });
      return _this117;
    }
  ...
  var ControlsContainer = /*#__PURE__*/function (_paella$DomNode12) {
    ...
    function ControlsContainer(id) {
      ...
      _this119.playbackControlId = '';
      _this119.editControlId = '';
      _this119.isEnabled = true;
      _this119.autohideTimer = null;
      _this119.hideControlsTimeMillis = 3000;
      _this119.playbackControlInstance = null;
      _this119.videoOverlayButtons = null;
      _this119.buttonPlugins = [];
      _this119._hidden = false;
      _this119._over = false;
      _this119.viewControlId = id + '_view';
      _this119.playbackControlId = id + '_playback';
      _this119.editControlId = id + '_editor';

      _this119.addNode(new paella.PlaybackControl(_this119.playbackControlId));
      ...
      $(_this119.domElement).bind("mousemove", function (event) {
        thisClass._over = true;
      });
      $(_this119.domElement).bind("mouseout", function (event) {
      ...
      _this119.videoOverlayButtons = new paella.DomNode('div', id + '_videoOverlayButtonPlugins');
      _this119.videoOverlayButtons.domElement.className = 'videoOverlayButtonPlugins';

      _this119.videoOverlayButtons.domElement.setAttribute("role", "toolbar");

      _this119.addNode(_this119.videoOverlayButtons);

      paella.pluginManager.setTarget('videoOverlayButton', _assertThisInitialized(_this119));
      return _this119;
    }
...
(function () {
  var LoaderContainer = /*#__PURE__*/function (_paella$DomNode13) {
    ...
    function LoaderContainer(id) {
      ...
      _this122 = _super42.call(this, 'div', id, {
        position: 'fixed',
      ...
      _this122.timer = null;
      _this122.loader = null;
      _this122.loaderPosition = 0;
      _this122.loader = _this122.addNode(new paella.DomNode('i', '', {
        width: "100px",
        height: "100px",
        color: "black",
        display: "block",
      ...
      _this122.loader.domElement.className = "icon-spinner";
      paella.events.bind(paella.events.loadComplete, function (event, params) {
        _this122.loadComplete(params);
      });
      _this122.timer = new base.Timer(function (timer) {
        //thisClass.loaderPosition -= 128;
        //thisClass.loader.domElement.style.backgroundPosition = thisClass.loaderPosition + 'px';
        _this122.loader.domElement.style.transform = "rotate(".concat(_this122.loaderPosition, "deg");
        _this122.loaderPosition += 45;
      }, 250);
      _this122.timer.repeat = true;
      return _this122;
    }
    ...
    _createClass(KeyManager, [{
      ...
      value: function addPlugin(plugin) {
        ...
        if (plugin.checkEnabled(function (e) {
          _this123._pluginList.push(plugin);
  ...
  var InitDelegate = /*#__PURE__*/function () {
    ...
    _createClass(InitDelegate, [{
      ...
      value: function loadDictionary() {
        ...
        return new Promise(function (resolve) {
          base.ajax.get({
            url: _this125.initParams.dictionaryUrl + "_" + base.dictionary.currentLanguage() + '.json'
      ...
      value: function loadConfig() {
        ...
        var loadAccessControl = function loadAccessControl(data) {
          ...
          _this126.initParams.accessControl = new AccessControlClass();
        };

        if (this.initParams.config) {
          return new Promise(function (resolve) {
            loadAccessControl(_this126.initParams.config);
            resolve(_this126.initParams.config);
          });
        } else if (this.initParams.loadConfig) {
          return new Promise(function (resolve, reject) {
            _this126.initParams.loadConfig(_this126.initParams.configUrl).then(function (data) {
          ...
          return new Promise(function (resolve, reject) {
            var configUrl = _this126.initParams.configUrl;
            var params = {};
...
(function () {
  var PaellaPlayer = /*#__PURE__*/function (_paella$PlayerBase) {
    ...
    function PaellaPlayer(playerId) {
      ...
      _this127 = _super44.call(this, playerId);
      _this127.player = null;
      _this127.videoIdentifier = '';
      _this127.loader = null; // Video data:

      _this127.videoData = null; // if initialization ok

      if (_this127.playerId == playerId) {
        _this127.loadPaellaPlayer();

        var thisClass = _assertThisInitialized(_this127);
      }
    ...
    _createClass(PaellaPlayer, [{
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          _this128.videoContainer.play().then(function () {
            if (!_this128.controls) {
              _this128.showPlaybackBar();

              paella.events.trigger(paella.events.controlBarLoaded);

              _this128.controls.onresize();
            }
      ...
      value: function playing() {
        ...
        return new Promise(function (resolve) {
          _this129.paused().then(function (p) {
            resolve(!p);
          });
        });
      }
  ...
  var LazyThumbnailContainer = /*#__PURE__*/function (_paella$DomNode14) {
    ...
    function LazyThumbnailContainer(src) {
      ...
      _this130 = _super45.call(this, 'img', 'lazyLoadThumbnailContainer', {});
      ...
      _this130.domElement.src = url.absoluteUrl;
      _this130.domElement.alt = "";
      _this130.container = LazyThumbnailContainer.GetIconElement();

      if (!paella.player.videoContainer) {
        document.body.appendChild(_this130.container);
      }
  ...
  var PaellaPlayerLazy = /*#__PURE__*/function (_PaellaPlayer) {
    ...
    function PaellaPlayerLazy(playerId, initDelegate) {
      ...
      _this131 = _super46.call(this, playerId, initDelegate);
      g_lazyLoadInstance = _assertThisInitialized(_this131);
      return _this131;
    }
        ...
        if (this.videoIdentifier) {
          ...
          loader.loadVideo(function () {
            if (!loader.metadata.preview) {
              paella.load(_this132.playerId, paella.loaderFunctionParams);
              g_lazyLoadInstance = null; // Lazy load is disabled when the video has no preview
            } else {
              _this132.lazyLoadContainer = new LazyThumbnailContainer(loader.metadata.preview);
              document.body.appendChild(_this132.lazyLoadContainer.domElement);

              _this132.lazyLoadContainer.onClick(function () {
                _this132.lazyLoadContainer.destroyElements();

                _this132.lazyLoadContainer = null;
                _this132._onPlayClosure && _this132._onPlayClosure();
              });
...
(function () {
  ...
  var DefaultVideoLoader = /*#__PURE__*/function (_paella$VideoLoader) {
    ...
    function DefaultVideoLoader(data) {
      ...
      _this133 = _super47.call(this, data);
      _this133._url = null;
      ...
      if (_typeof(data) == "object") {
        ...
        try {
          _this133._data = JSON.parse(data);
        } catch (e) {
          _this133._url = data;
        }
      }
      ...
      value: function loadVideo(onSuccess) {
        ...
        if (this._data) {
          ...
          loadVideoDelegate().then(function (data) {
            ...
            _this134.loadVideoData(_this134._data, onSuccess);
          });
        } else if (url) {
          var This = this;
          base.ajax.get({
        ...
        if (window.WebKitPlaybackTargetAvailabilityEvent) {
          video.addEventListener('webkitplaybacktargetavailabilitychanged', function (event) {
            switch (event.availability) {
              case "available":
                _this135._visible = true;
                break;

              case "not-available":
                _this135._visible = false;
                break;
            }

            _this135.updateClassName();
          });
        }
      }
    }, {
        ...
        return new Promise(function (resolve) {
          if (_this136._frames.length < 1) {
            ...
            paella.player.videoContainer.duration().then(function (d) {
              ...
              if (!_this136._frames.some(function (f1, i, array) {
                if (i + 1 == array.length) {
                  return;
                }

                var f0 = i == 0 ? f1 : _this136._frames[i - 1];
                var f2 = _this136._frames[i + 1];
                ...
                var t0 = _this136._frames[_this136._frames.length - 2].time;
                var t1 = _this136._frames[_this136._frames.length - 1].time;
                resolve({
    ...
    _createClass(AudioSelector, [{
      ...
      value: function checkEnabled(onSuccess) {
        ...
        this._mainPlayer.supportsMultiaudio().then(function (supports) {
          if (supports) {
            _this137._legacyMode = false;
            return _this137._mainPlayer.getAudioTracks();
          } else {
            _this137._legacyMode = true;
            return paella.player.videoContainer.getAudioTags();
          }
        }).then(function (audioTracks) {
          if (_this137._legacyMode) {
            _this137._tags = audioTracks;
            return Promise.resolve();
          } else {
            _this137._audioTracks = audioTracks;
            return _this137._mainPlayer.getCurrentAudioTrack();
          }
        }).then(function (defaultAudioTrack) {
          if (_this137._legacyMode) {
            onSuccess(_this137._tags.length > 1);
          } else {
            _this137._defaultAudioTrack = defaultAudioTrack;
            onSuccess(true);
          }
        });
      }
        ...
        if (this._legacyMode) {
          this._tags.forEach(function (tag, index) {
            buttonItems.push({
              ...
              value: tag,
              icon: "",
              className: _this138.getButtonItemClass(tag),
          ...
          this._audioTracks.forEach(function (track) {
            buttonItems.push({
              ...
              value: track.id,
              icon: "",
              className: _this138.getButtonItemClass(track.id),
              "default": track.id == _this138._defaultAudioTrack.id
            });
          });
        }
    ...
    _createClass(BreaksPlayerPlugin, [{
      ...
      value: function onEvent(eventType, params) {
        ...
        paella.player.videoContainer.currentTime(true).then(function (currentTime) {
          ...
          var diff = Math.abs(currentTime - _this140.lastTime);

          _this140.checkBreaks(currentTime, diff >= 1 ? paella.events.seekToTime : paella.events.timeUpdate);

          _this140.lastTime = currentTime;
        });
      }
    }, {
      key: "checkBreaks",
      value: function checkBreaks(currentTime, eventType) {
        ...
        if (this.breaks.some(function (breakItem) {
          if (breakItem.s <= currentTime && breakItem.e >= currentTime) {
            if (eventType == paella.events.timeUpdate && !_this141.status) {
              _this141.skipTo(breakItem.e);
            }
      ...
      value: function updateCaptions(time) {
        ...
        if (this.captions) {
          paella.player.videoContainer.trimming().then(function (trimming) {
            ...
            if (caption) {
              $(_this143.container).show();
              _this143.innerContainer.innerText = caption.content;

              _this143.moveCaptionsOverlay("auto");
            } else {
              _this143.innerContainer.innerText = "";

              _this143.hideContent();
            }
          });
        }
      }
...
(function () {
  function buildChromaVideoCanvas(stream, canvas) {
    var ChromaVideoCanvas = /*#__PURE__*/function (_bg$app$WindowControl3) {
      ...
      function ChromaVideoCanvas(stream) {
        ...
        _this144 = _super68.call(this);
        _this144.stream = stream;
        _this144._chroma = bg.Color.White();
        _this144._crop = new bg.Vector4(0.3, 0.01, 0.3, 0.01);
        _this144._transform = bg.Matrix4.Identity().translate(0.6, -0.04, 0);
        _this144._bias = 0.01;
        return _this144;
      }
  ...
  var ChromaVideo = /*#__PURE__*/function (_paella$VideoElementB4) {
    ...
    function ChromaVideo(id, stream, left, top, width, height, streamName) {
      ...
      _this147 = _super69.call(this, id, stream, 'canvas', left, top, width, height);
      _this147._posterFrame = null;
      _this147._currentQuality = null;
      _this147._autoplay = false;
      _this147._streamName = null;
      _this147._streamName = streamName || 'chroma';

      var This = _assertThisInitialized(_this147);

      if (_this147._stream.sources[_this147._streamName]) {
        _this147._stream.sources[_this147._streamName].sort(function (a, b) {
          return a.res.h - b.res.h;
        });
      }
    ...
    _createClass(ChromaVideo, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          if (_this148.video) {
            ...
            $(_this148.video).bind('canplay', function () {
              _this148._ready = true;
              resolve(action());
            });
          }
        });
      ...
      value: function getVideoData() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this149._deferredAction(function () {
            resolve({
              duration: This.video.duration,
              currentTime: This.video.currentTime,
              volume: This.video.volume,
      ...
      value: function load() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this150._loadDeps().then(function () {
            var sources = _this150._stream.sources[_this150._streamName];

            if (_this150._currentQuality === null && _this150._videoQualityStrategy) {
              _this150._currentQuality = _this150._videoQualityStrategy.getQualityIndex(sources);
            }

            var stream = _this150._currentQuality < sources.length ? sources[_this150._currentQuality] : null;
            _this150.video = null;
            _this150.domElement.parentNode.style.backgroundColor = "transparent";

            if (stream) {
              _this150.canvasController = null;
              buildChromaVideoCanvas(stream, _this150.domElement).then(function (canvasController) {
                _this150.canvasController = canvasController;
                _this150.video = canvasController.video;

                _this150.video.pause();

                if (stream.crop) {
                  _this150.canvasController.crop = new bg.Vector4(stream.crop.left, stream.crop.top, stream.crop.right, stream.crop.bottom);
                }

                if (stream.displacement) {
                  _this150.canvasController.transform = bg.Matrix4.Translation(stream.displacement.x, stream.displacement.y, 0);
                }

                if (stream.chromaColor) {
                  _this150.canvasController.chroma = new bg.Color(stream.chromaColor[0], stream.chromaColor[1], stream.chromaColor[2], stream.chromaColor[3]);
                }

                if (stream.chromaBias) {
                  _this150.canvasController.bias = stream.chromaBias;
                }
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve, reject) {
          setTimeout(function () {
            ...
            sources.forEach(function (s) {
              index++;
              result.push(_this151._getQualityObject(index, s));
            });
            resolve(result);
          }, 10);
        });
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve) {
          var paused = _this152.video.paused;
          var sources = _this152._stream.sources[_this152._streamName];
          _this152._currentQuality = index < sources.length ? index : 0;
          var currentTime = _this152.video.currentTime;

          _this152.freeze().then(function () {
            _this152._ready = false;
            return _this152.load();
          }).then(function () {
            if (!paused) {
              _this152.play();
            }

            $(_this152.video).on('seeked', function () {
              _this152.unFreeze();

              resolve();
              $(_this152.video).off('seeked');
            });
            _this152.video.currentTime = currentTime;
          });
        });
      }
    }, {
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve) {
          resolve(_this153._getQualityObject(_this153._currentQuality, _this153._stream.sources[_this153._streamName][_this153._currentQuality]));
        });
      }
    }, {
      key: "play",
      ...
      value: function duration() {
        ...
        return this._deferredAction(function () {
          return _this157.video.duration;
        });
      }
    }, {
      key: "setCurrentTime",
      value: function setCurrentTime(time) {
        ...
        return this._deferredAction(function () {
          _this158.video.currentTime = time;
          $(_this158.video).on('seeked', function () {
            _this158.canvasController.postRedisplay();

            $(_this158.video).off('seeked');
          });
        });
      }
    }, {
      ...
      value: function currentTime() {
        ...
        return this._deferredAction(function () {
          return _this159.video.currentTime;
        });
      }
    }, {
      key: "setVolume",
      ...
      value: function setPlaybackRate(rate) {
        ...
        return this._deferredAction(function () {
          _this162.video.playbackRate = rate;
        });
      }
    }, {
      key: "playbackRate",
      value: function playbackRate() {
        ...
        return this._deferredAction(function () {
          return _this163.video.playbackRate;
        });
      }
    }, {
      key: "goFullScreen",
      ...
      value: function unFreeze() {
        ...
        return this._deferredAction(function () {
          var c = document.getElementById(_this165.video.className + "canvas");
          $(c).remove();
        });
      }
    }, {
...
(function () {
  var MpegDashVideo = /*#__PURE__*/function (_paella$Html5Video2) {
    ...
    function MpegDashVideo(id, stream, left, top, width, height) {
      ...
      _this184 = _super82.call(this, id, stream, left, top, width, height, 'mpd');
...
(function () {
  var RTMPVideo = /*#__PURE__*/function (_paella$VideoElementB5) {
    ...
    function RTMPVideo(id, stream, left, top, width, height) {
      ...
      _this204 = _super92.call(this, id, stream, 'div', left, top, width, height);
...
(function () {
  var YoutubeVideo = /*#__PURE__*/function (_paella$VideoElementB6) {
    ...
    function YoutubeVideo(id, stream, left, top, width, height) {
      ...
      _this223 = _super116.call(this, id, stream, 'div', left, top, width, height);
