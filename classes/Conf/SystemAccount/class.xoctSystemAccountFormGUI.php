...
class xoctSystemAccountFormGUI extends ilPropertyFormGUI {
	...
	protected function initButtons() {
		if ($this->is_new) {
			...
			$this->addCommandButton(xoctSystemAccountGUI::CMD_CREATE, $this->txt(xoctSystemAccountGUI::CMD_CREATE));
		} else {
			$this->setTitle($this->txt('edit'));
			$this->addCommandButton(xoctSystemAccountGUI::CMD_UPDATE, $this->txt(xoctSystemAccountGUI::CMD_UPDATE));
		}

		$this->addCommandButton(xoctSystemAccountGUI::CMD_CANCEL, $this->txt(xoctSystemAccountGUI::CMD_CANCEL));
	}
